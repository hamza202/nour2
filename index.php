                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col text-center">
                                        <img class="img-fluid" src="images/slider/s2.png" alt="">
                                    </div>
                                    <div class="col text-center d-flex justify-content-center align-self-lg-center">
                                        <div class="slider-content">
                                            ...
                                            <a href="#" class="slider-btn white-btn">Git it Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="carousel-caption ">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col text-center">
                                        <img class="img-fluid" src="images/slider/rqmnh-banner-2.png" alt="">
                                    </div>
                                    <div class="col text-center d-flex justify-content-center align-self-lg-center">
                                        <div class="slider-content">
                                            <h2>Lorem ipsum dolor sit</h2>
                        ...
                        <div class="carousel-caption ">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col text-center">
                                        <img class="img-fluid" src="images/slider/s3.png" alt="">
                                    </div>
                                    <div class="col text-center d-flex justify-content-center align-self-lg-center">
                                        <div class="slider-content">
                                            <h2>Lorem ipsum dolor sit</h2>
        ...
        <section class="our-service mt-5">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="row mt-3">
                        <div class="col-lg-4">
                            <h3 class="second-title">Test Title</h3>
                            <p class="text-justify paragraph">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                Beatae consectetur doloremque
                                magnam natus nobis perspiciatis, soluta velit voluptates! Atque aut dolores ducimus eos
                                exercitationem minus nam natus repellendus rerum vero.
                            </p>
                        </div>
                        <div class="col-lg-4">
                            <h3 class="second-title">Test Title</h3>
                    ...
                    <div class="row ">
                        <div class="col-lg-8 ">
                            ...
                            <p class="text-justify paragraph m-0 ">Lorem ipsum dolor sit amet, consectetur adipisicing
                                ...
                                magnam natus nobis perspiciatis, soluta velit voluptates! Atque aut dolores ducimus eos
                                exercitationem minus nam natus repellendus rerum vero.
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae consectetur doloremque
                                magnam natus nobis perspiciatis, soluta velit voluptates! Atque aut dolores ducimus eos
                                exercitationem minus nam natus repellendus rerum vero.
                            </p>
            ...
            <div class="row">
                <div class="col">
                    <div class="owl-carousel .owl-theme rate-slider">
                        <div class="item">
                            <img class="rate-slider-img" src="images/slider/man1.png" alt="">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi deserunt itaque laudantium nisi
                                omnis perspiciatis quos repellendus sit temporibus ullam! Accusamus aspernatur dolorum ipsam
                                minus pariatur quisquam soluta, tenetur </p>
                        </div>
                        <div class="item">
                            <img class="rate-slider-img" src="images/slider/man2.png" alt="">
                            <h3>Ahmed mohammed</h3>
                            <div class="product-reviews-summary in-comment">
                                <div class="rating-summary">
                                    <div class="rating-result" title="100%">
